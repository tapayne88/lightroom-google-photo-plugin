...
publishServiceProvider.titleForPublishedCollection_standalone =
	LOC("$$$/GPhoto/TitleForPublishedCollection/Standalone=Album")
publishServiceProvider.titleForPublishedSmartCollection = LOC("$$$/GPhoto/TitleForPublishedSmartCollection=Smart Album")
publishServiceProvider.titleForPublishedSmartCollection_standalone =
	LOC("$$$/GPhoto/TitleForPublishedSmartCollection/Standalone=Smart Album")
